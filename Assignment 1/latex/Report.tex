...
\begin{document}
    ...
    heavy amount of erosion performed on the image prevented the two clusters from forming a single one.
      ...
      sound track is played.
        ...
        \begin{figure}[H]
          \includegraphics[width=0.25\linewidth]{192}
          \includegraphics[width=0.25\linewidth]{193}
          \includegraphics[width=0.25\linewidth]{193}
          \includegraphics[width=0.25\linewidth]{194}
          \includegraphics[width=0.25\linewidth]{195}
          \includegraphics[width=0.25\linewidth]{196}
          \includegraphics[width=0.25\linewidth]{197}
